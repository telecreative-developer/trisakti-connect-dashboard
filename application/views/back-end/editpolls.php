                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <?php foreach($polls as $output_polls){?>
                                <?php echo form_open_multipart('uppolls');?>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <div class="hidden" span style="display:none;">
                                                <input type="text" name="id" value="<?php echo $output_polls->id_poll;?>">
                                            </div>
                                            <input id="title" type="text" class="validate" name="title" value="<?php echo $output_polls->title_poll;?>">
                                        </div>  
                                        ...
                                        <div class="input-field col s12">
                                            <small> Content </small>
                                            <textarea id="content" class="materialize-textarea" name="content"><?php echo $output_polls->content_poll;?></textarea>
                                        </div>
