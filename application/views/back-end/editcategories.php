                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content">
                                    <span class="card-title">Input Category</span><br>
                                    <div class="row">
                                        <div class="col-lg-12" id="form-padding">
                                        <?php foreach($categories as $cat){?>
                                        <?php echo form_open_multipart('DashboardController/updatecategories');?>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <div class="hidden" span style="display:none;">
                                                        <input type="text" name="id" value="<?php echo $cat->id_category;?>">
                                                    </div>
                                                    <input id="title" type="text" class="validate" name="title" value="<?php echo $cat->category;?>">
                                                </div>
                                                <div class="input-field col s6">
