                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content">
                                    <span class="card-title">Input Majors</span><br>
                                    <div class="row">
                                        <div class="col-lg-12" id="form-padding">
                                        <?php echo form_open_multipart('insertmajors');?>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input id="title" type="text" class="validate" required="ON" name="majors">
                                                    <label for="title">Majors</label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <select name="id_faculty" required>
                                                        <option value="" selected="by" disabled="ON"> Faculty </option>
                                                        <?php foreach($faculty as $fal){
                                                        ?>
