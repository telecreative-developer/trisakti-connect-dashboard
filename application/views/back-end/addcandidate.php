                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content">
                                    <span class="card-title">Input Candidate</span><br>
                                    <div class="row">
                                        <div class="col-lg-12" id="form-padding">
                                        <?php echo form_open_multipart('insertcandidate');?>
                                            <div class="row">
                                                <div class="input-field col s4">
                                                    <input id="title" type="text" class="validate" required="ON" name="candidate" maxlength="100" >
                                                    <label for="title">Candidate</label>
                                                </div>
                                                <div class="input-field col s4">
                                                    <select name="id_poll" required>
                                                        <option value="" selected="by" disabled="ON">Title Poll </span></option>
                                                        <?php foreach($candidate as $can){
                                                        ?>
                                                        
                                                        <option value="<?php echo $can->id_poll;?>"><?php echo $can->title_poll;?> </option>
