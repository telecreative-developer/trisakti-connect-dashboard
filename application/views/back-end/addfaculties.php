                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content">
                                    <span class="card-title">Input Faculties</span><br>
                                    <div class="row">
                                        <div class="col-lg-12" id="form-padding">
                                        <?php echo form_open_multipart('insertfaculties');?>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input id="title" type="text" class="validate" required="ON" name="faculty">
