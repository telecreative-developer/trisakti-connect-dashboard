                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Candidate 
                                <br>
                                <a href="<?php echo base_url();?>addcandidate" class="waves-effect light-blue darken-4 btn">New Candidate</a>
                                </span>
                                <table id="example" class="display responsive-table datatable-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="38%">Candidate</th>
                                            <th width="38%">Title Polls</th>
                                            <th>Action </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td><img src="<?php echo $can->avatar;?>" width="80%"></td> 
                                            
                                            <?php 
                                            }
                                            ?>
                                            <td><?php echo $can->candidate;?></td>
                                            <td><?php echo $can->title_poll;?>
                                            <td>

                                                <a href="<?php echo base_url() . "editcandidate/" . $can->idpoll_choice; ?>">
                                                    <i class="material-icons left">edit</i>
                                                </a>

                                                <a onclick="javascript:return confirm('Delete ?')" href="<?php echo base_url() . "deleteCandidate/" . $can->idpoll_choice; ?>">
