                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-content">
                                    <span class="card-title">Edit Faculties</span><br>
                                    <div class="row">
                                        <div class="col-lg-12" id="form-padding">
                                        <?php foreach($faculties as $fal){?>
                                        <?php echo form_open_multipart('DashboardController/updatefaculties');?>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <div class="hidden" span style="display:none;">
                                                        <input type="text" name="id" value="<?php echo $fal->id_faculty;?>">
                                                    </div>
                                                    <input id="title" type="text" class="validate" name="faculty" value="<?php echo $fal->faculty;?>">
                                                </div>
                                                <div class="input-field col s6">
