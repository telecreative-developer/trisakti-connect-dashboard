                        ...
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $vote->title_polls;?>
                                    <?php 
                                        $candidate = $vote->candidate;
                                        $x = $vote->id_polls_choice;

                                        $id_polls =  $vote->id_polls;

                                        $sql = $this->db->query("SELECT COUNT(*) as total FROM polls_answers,polls_choice WHERE polls_answers.id_polls = '$id_polls' AND polls_choice.id_polls_choice = '$x' AND polls_answers.id_polls_choice = '$x' GROUP BY polls_answers.id_polls_choice = '$x' ");
                                        $row = $sql->row();
                                    ?>
                                    <td>
                                        <?php  
