            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Polls 
                        <br>
                        <a href="addpolls" class="waves-effect light-blue darken-4 btn">New Title Polls</a>
                        </span>
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            <tbody>
                                <?php 
                                    $no = 1;
                                    foreach ($title_pols as $pols) {
                                    $render = $pols->thumbnail_poll;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Flag_of_None.svg/2000px-Flag_of_None.svg.png" width="100%" />

                                        <?php 
                                        }else{
                                        ?>
                                         <img src="<?php echo $pols->thumbnail_poll;?>" width="100%">
                                        <?php 
                                            }
                                        ?>
                                    ...
                                    <td><?php echo $pols->title_poll;?></td>
                                    <td><?php echo substr($pols->content_poll,0,150);?> .. </td>
                                    <td>
