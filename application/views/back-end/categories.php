            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Categories 
                        <br>
                        <a href="addcategories" span style="display:none" class="waves-effect light-blue darken-4 btn">New Category</a>
                        </span>
                        <table id="example" class="display responsive-table datatable-example">
                            <thead>
                                <tr>
                                    <th width="40">No</th>
                                    <th>Title</th>
                                    <th span style="display:none">Action </th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . "editcategories/" . $cat->id_category; ?>">
                                            <button span style="display:none" class="waves-effect light-blue darken-4 btn"><i class="material-icons left">edit</i>Edit </button> 
                                        </a>

                                        <a onclick="javascript:return confirm('Delete ?')" href="<?php echo base_url() . "delcategories/" . $cat->id_category; ?>">
                                            
                                            <button span style="display:none" class="waves-effect red lighten-1 btn"><i class="material-icons left">close</i>Delete </button> 
                                        </a>
                                    </td>
                                </tr>
                                <?php
