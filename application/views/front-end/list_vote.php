										...
										<div class="post">
											<div class="name">
												...
												<?php 
													...
													$sql = $this->db->query("SELECT COUNT(*) as total FROM polls_answers,polls_choice WHERE polls_answers.id_polls = '$id' AND polls_choice.id_polls_choice = '$x' AND polls_answers.id_polls_choice = '$x' GROUP BY polls_answers.id_polls_choice = '$x' ");
													$row = $sql->row();
													$voted = $row->total;
												?>
